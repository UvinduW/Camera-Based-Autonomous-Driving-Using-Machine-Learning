...
def read_train_images(batch_size=-1, flip_rate=0.5):
    ...
    while True:
        ...
        while i < batch_size:
            ...
            angle = ((angle + 255.0) / 510.0)*2.0 - 1
            image_batch[i] = image
            angle_batch[i] = angle  # fix this line
            i += 1
        yield image_batch, angle_batch


def read_test_images(batch_size=-1):
...
# generator = read_train_images(10, 0.9)
# neg = 0
# pos = 0
#
